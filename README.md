...
[(Save and) close](save-close/) | Adds "(Save and) close (card)" option to the card footer. | No configuration required. | [/scripts/save-done/save-done.js](/save-done/save-done.js)
