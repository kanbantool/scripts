...
[Fixed cards height](fixed-cards-height) | Makes all cards the same height. | No configuration required. | [/scripts/fixed-cards-height/medium-cards.css](https://kanbantool.com/scripts/fixed-cards-height/medium-cards.css)
[Color card transition](color-card-transition/) | Change color card if is staying too long (30 minutes) in one column | Need add to workflow stage name and color card name "\*T\*" (read more in [Color card transition](color-card-transition/) folder) | [/scripts/color-card-transition/color-card-transition.js](https://kanbantool.com/scripts/color-card-transition/color-card-transition.js)